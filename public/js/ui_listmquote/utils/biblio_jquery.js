            ...
            <tr>
                <th colspan="2">
                    <table id="header" cellspacing="0px" cellpadding="2px" style="border: none; text-align: left;">
                        ...
                        <tr>
                            <td colspan="12">
                                <div class="col headerFont p-2 session-contact"><span class="material-icons">
                                language</span>${none}, <span class="material-icons">
                                phone</span>${orgData["phone"]}, <span class="material-icons">
                                alternate_email</span>${orgData["primary_email"]}, <span class="material-icons">
