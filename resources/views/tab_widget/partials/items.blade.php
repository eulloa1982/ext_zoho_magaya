@if (isset($organization['items']))
    ...
    @foreach ($organization['items'] as $dat=>$v)
        ...
        <tr>
            ...
            <td width="15%" style="border-right: 1px #000 solid; text-align: right;border-bottom: 1px #000 solid;">{{$v['magaya__Volume']}} ({{$measure_volume}})</td>
        </tr>
    @endforeach
    ...
    <tr>
        ...
        <td style="border-bottom: 1px #000 solid;border-right: 1px #000 solid; text-align: right; font-weight: bold;">{{ $total_volume }} ({{$measure_volume}})</td>
    </tr>
@endif
